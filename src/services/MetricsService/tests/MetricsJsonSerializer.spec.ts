...
describe('MetricsJsonSerializer', () => {
  it('can serialize metrics in JSON', async () => {
    ...
    const sut = new DefaultMetricsJsonSerializer(
      appVersion,
      appOs,
      osVersion,
      manufacturer,
