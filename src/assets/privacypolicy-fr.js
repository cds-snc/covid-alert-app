...
- On vous demandera aussi l’autorisation de téléverser vos codes aléatoires pendant les 13 jours qui suivent.
...
Vos renseignements médicaux restent entre les mains de votre fournisseur de soins de santé provincial ou territorial. Alerte COVID ne sait pas qui vous êtes et ne peut pas avoir accès ces renseignements.
- Le numéro à 8 chiffres fourni par votre professionnel de la santé indique à Alerte COVID que vous pouvez téléverser vos codes aléatoires.
- L’application Alerte COVID a confiance en ce numéro. Elle l’utilise pour ne pas avoir à collecter de renseignements personnels qui permettraient de vous identifier.
- Les travailleurs de la santé n’ont aucun moyen de fournir vos renseignements personnels à Alerte COVID.
- Afin de protéger l’intégrité des numéros à 8 chiffres fournis par votre fournisseur de soins de santé, votre province peut générer un long numéro d’identification interne garantissant que le numéro à 8 chiffres a été généré par une source valide. Le gouvernement du Canada n’est pas en mesure de faire le lien entre ces numéros d’identification internes et vous ou d’autres utilisateurs de l’application, et ces numéros ne sont utilisés qu’en cas de besoin pour prévenir les menaces de cybersécurité.

## Votre adresse IP
- Par mesure de sécurité, si vous saisissez un numéro à 8 chiffres incorrect, l’application stockera votre adresse IP pendant 5 minutes. L’application fait cela pour se protéger contre les personnes malveillantes.
