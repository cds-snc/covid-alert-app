...
export const CollapsedMenuView = () => {
  ...
  return (
    <Box style={styles.content}>
      <Box marginBottom="s" marginLeft="s" paddingLeft="s" style={styles.scanBox} backgroundColor="buttonGrey">
      ...
      <Box marginBottom="s" marginRight="s" paddingLeft="s" style={styles.menuBox} backgroundColor="buttonGrey">
