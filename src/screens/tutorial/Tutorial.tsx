...
import {Box, Button, ProgressCircles, ToolbarWithClose} from 'components';
  ...
  return (
    <Box backgroundColor="overlayBackground" flex={1}>
      <SafeAreaView style={styles.flex}>
        <ToolbarWithClose closeText={i18n.translate('Tutorial.Close')} showBackButton={false} onClose={close} />
